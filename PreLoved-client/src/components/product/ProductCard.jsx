    ...
    <Card style={{minWidth: '13rem', border: 'none'}}>
      <div className="bg-secondary h-100">
        <div className="d-flex justify-content-between px-3 pt-2 head-div">
          ...
          <MdFavoriteBorder size={22} className="on-point" onMouseEnter={() => setOpen(true)} onMouseLeave={() => setOpen(false)} onClick={handleFavorite}></MdFavoriteBorder>
        </div>
        <div className="card-img-div">
          <Card.Img variant="top" src={data.url} className="on-point pb-2 product-image" />
        </div>
      </div>
