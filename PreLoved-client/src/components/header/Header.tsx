    ...
    <>
      <Stack>
        ...
        <Stack
          ...
          gap={3}
          className="nav d-flex justify-content-between px-5 py-2">
          <div className="input-div">
            <div className="input-group">
              <input
                type="text"
                className="form-control border border-end-0 rounded-start"
          ...
          <div className="d-flex-end d-flex icon-text">
            <div className="icon-container">
              ...
              <span>Sell Now</span>
              <span className="position-absolute top-0 start-100 translate-middle border border-light rounded-pill badge">
                New!
              </span>
            </div>
            <div className="icon-container">
            ...
            <div className="icon-container">
              ...
              <span>Cart</span>
              <span className="position-absolute top-0 start-100 translate-middle border border-light rounded-circle badge">
                12
              </span>
            </div>
            {auth && open && (
